...
const steps = [
  {
    ...
    description:
      'Get started by exploring our course catalog and customizing your profile.',
  },
  {
    title: 'Track Your Progress',
    description:
      'Mark lessons as complete and see your learning journey unfold.',
  },
  {
    title: 'Join the Community',
    description:
      'Leave reviews, ask questions, and connect with other learners.',
  },
];
...
export default function OnboardingModal({ onClose }: OnboardingModalProps) {
  ...
  return (
    <div className="flex flex-col items-center p-6 min-w-[320px] max-w-[90vw]">
      ...
      <p className="text-[color:var(--ai-muted)] mb-6 text-center">
