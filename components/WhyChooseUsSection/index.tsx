      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <ScrollAnimationWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-[color:var(--ai-muted)] max-w-3xl mx-auto">
                We&apos;ve designed our learning experience with developers in
                mind, focusing on what matters most
              </p>
            </div>
          </ScrollAnimationWrapper>
          <motion.div
          ...
          <div className="absolute inset-0 z-0 opacity-30 pointer-events-none overflow-hidden">
            <svg
              className="absolute right-0 top-0 h-full transform translate-x-1/2"
              width="404"
              height="784"
              fill="none"
              viewBox="0 0 404 784"
            >
              ...
              <rect
                ...
                className="text-[color:var(--ai-foreground)]"
              />
            </svg>
            <svg
              className="absolute left-0 bottom-0 h-full transform -translate-x-1/2"
              width="404"
              height="784"
              fill="none"
              viewBox="0 0 404 784"
