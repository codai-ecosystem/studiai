      ...
      <CardBody className="p-6">
        ...
        {unlockedAchievements.length > 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {unlockedAchievements.map((ach, index) => (
                ...
                >
                  ...
                  <Chip
                    color={(ach.badgeColor as any) || 'primary'}
                    variant="solid"
                    className="mb-2"
                  >
                    {ach.title}
                  </Chip>
                  <div className="text-sm text-[color:var(--ai-foreground)] font-medium mb-1 text-center">
                    {ach.description}
                  </div>
                  <div className="text-xs text-[color:var(--ai-muted)]">
                    {ach.date instanceof Date
                      ...
                      : typeof ach.date === 'string'
                        ...
                        : ach.date?.toDate()?.toLocaleDateString() ||
                          'Unknown date'}
                  </div>
                </motion.div>
              ))}
          ...
          <div className="text-center py-6 mb-6">
            ...
            <p className="text-[color:var(--ai-muted)] mb-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {lockedAchievements.map((ach, index) => (
                ...
                >
                  ...
                  <div className="text-sm text-[color:var(--ai-muted)] mb-1 text-center">
                    {ach.description}
                  </div>
                </motion.div>
              ))}
