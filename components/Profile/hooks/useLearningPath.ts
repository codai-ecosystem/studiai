    ...
    async function fetchLearningPath() {
      ...
      try {
        ...
        for (const courseId of purchasedCourseIds) {
          ...
          const completedLessons = Object.values(courseLessonsProgress).filter(
          ...
          let status: 'completed' | 'in-progress' | 'upcoming' | 'locked' =
            'upcoming';
        ...
        if (currentCourseId && !nextCourseId) {
          ...
          const upcomingCourse = courseNodes.find(
