      ...
      <CardBody className="p-6">
        ...
        {activities.length > 0 ? (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-[color:var(--ai-foreground)]">
                    {activity.lessonName
                      ? `Continued "${activity.lessonName}"`
                      : `Accessed "${activity.courseName}"`}
                  </p>
          ...
          <div className="text-center py-8 px-4">
            ...
            <p className="text-[color:var(--ai-foreground)] font-medium mb-1">
              No recent activity yet
            </p>
            <p className="text-[color:var(--ai-muted)] text-sm mb-4">
              Start exploring courses to track your learning journey
            </p>{' '}
            <Link href="/courses">
              <Button
                size="sm"
