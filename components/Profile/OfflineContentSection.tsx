...
export default function OfflineContentSection() {
  ...
  const offlineLessons = offlineContent.filter(
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
                <div className="bg-[color:var(--ai-card-bg)] p-6 rounded-lg shadow-xl max-w-md w-full">
                  ...
                  <p className="text-[color:var(--ai-muted)] mb-4">
                    Are you sure you want to delete all offline content? This
                    will remove all downloaded lessons and you'll need an
                    internet connection to access them again.
                  </p>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-[color:var(--ai-muted)] max-w-md">
                Download lessons to view them offline. Look for the download
                button when viewing a lesson.
              </p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div className="flex sm:flex-col items-center gap-2">
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          removeOfflineContent(content.id, content.type)
                        }
                      >
                        <FiTrash2 size={16} />
                      </Button>
