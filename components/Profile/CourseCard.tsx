        ...
        <CardBody className="p-0">
          ...
          <div className="relative">
            <div className="h-36 bg-gradient-to-r from-[color:var(--ai-primary)] via-[color:var(--ai-secondary)] to-[color:var(--ai-accent)] relative">
              ...
              <div
                className="absolute right-10 top-8 w-4 h-4 rounded-full bg-white/20"
                style={{ animationDelay: '0.5s' }}
              ></div>

              {/* Course title */}
              <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black/80 via-black/60 to-transparent">
                <h3 className="text-white font-bold text-xl line-clamp-1 drop-shadow-md">
                  {course.name}
                </h3>
              </div>
            </div>{' '}
            ...
            <div className="absolute top-4 left-4">
              {course.status === 'completed' && (
                <Chip
                  ...
                  variant="flat"
                  size="sm"
                  className="backdrop-blur-sm bg-black/20 border border-green-500/30 text-white shadow-sm"
                >
                  Completed
                </Chip>
              )}
              {course.status === 'in-progress' && (
                <Chip
                  ...
                  variant="flat"
                  size="sm"
                  className="backdrop-blur-sm bg-black/20 border border-blue-500/30 text-white shadow-sm"
                >
                  In Progress
                </Chip>
              )}
              {course.status === 'not-started' && (
                <Chip
                  ...
                  variant="flat"
                  size="sm"
                  className="backdrop-blur-sm bg-black/20 border border-white/20 text-white shadow-sm"
                >
                  Not Started
                </Chip>
              )}
          ...
          <div className="p-5">
            <div className="flex flex-wrap gap-3 mb-4">
              <div className="inline-flex items-center text-xs text-[color:var(--ai-foreground)]/70 bg-[color:var(--ai-card-bg)]/80 px-2 py-1 rounded-full border border-[color:var(--ai-card-border)]/20">
                <FiClock className="mr-1.5 text-[color:var(--ai-primary)]" />{' '}
                {course.duration || '10 hours'}
              </div>
              <div className="inline-flex items-center text-xs text-[color:var(--ai-foreground)]/70 bg-[color:var(--ai-card-bg)]/80 px-2 py-1 rounded-full border border-[color:var(--ai-card-border)]/20">
                <FiLayers className="mr-1.5 text-[color:var(--ai-secondary)]" />{' '}
                {course.totalLessons} lessons
              </div>
              <div className="inline-flex items-center text-xs text-[color:var(--ai-foreground)]/70 bg-[color:var(--ai-card-bg)]/80 px-2 py-1 rounded-full border border-[color:var(--ai-card-border)]/20">
                <FiBarChart2 className="mr-1.5 text-[color:var(--ai-accent)]" />{' '}
