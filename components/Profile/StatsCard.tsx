  ...
  return (
    ...
    >
      ...
      <Card className="border border-[color:var(--ai-card-border)] overflow-hidden h-full rounded-xl shadow-sm bg-white dark:bg-[color:var(--ai-card-bg)]">
        <div
          className={`absolute top-0 right-0 w-24 h-24 -mt-8 -mr-8 rounded-full bg-gradient-to-br ${colorClass} opacity-20 blur-sm`}
        ></div>
        ...
        <CardBody className="p-5">
          <div className="flex items-center gap-4">
            <div
              className={`p-3 rounded-lg bg-gradient-to-br ${colorClass} bg-opacity-10 dark:bg-opacity-25 shadow-inner`}
            >
              {icon}
            </div>
            <div>
