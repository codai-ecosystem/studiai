  ...
  const getCourseChartData = () => {
    ...
    const displayedCourses = userPaidProducts
      ...
      .map(product => {
        ...
        const courseLessons = Object.keys(
          lessonProgress[courseId] || {}
        ).length;
        const courseCompleted = Object.values(
          lessonProgress[courseId] || {}
        ...
        {viewType === 'chart' ? (
              ...
              >
                <div className="flex flex-wrap gap-4 justify-around mt-4">
                  <div className="text-center">
                    <h3 className="text-sm font-medium mb-2 text-[color:var(--ai-muted)]">
                      Course Completion
                    </h3>
                    <ProgressChart
              ...
              <div>
                ...
                <Progress
                  ...
                  classNames={{
                    track: 'h-2 rounded-full',
                    indicator:
                      'bg-gradient-to-r from-[color:var(--ai-success)] to-[color:var(--ai-secondary)] rounded-full',
                  }}
                />
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="mt-6 pt-5 border-t border-[color:var(--ai-card-border)]/30">
              <h3 className="text-sm font-semibold mb-4 text-[color:var(--ai-foreground)]">
              ...
              <div className="space-y-5">
                {userPaidProducts.map((product, index) => {
                  ...
                  return (
                    <div
                      key={`${courseId}-${index}`}
                      className="bg-[color:var(--ai-card-bg)]/50 p-3 rounded-lg border border-[color:var(--ai-card-border)]/10"
                    >
                      ...
                      <Progress
                        ...
                        classNames={{
                          ...
                          indicator: `bg-gradient-to-r rounded-full ${
                            index % 3 === 0
                              ? 'from-[color:var(--ai-primary)] to-[color:var(--ai-accent)]'
                              : index % 3 === 1
                                ? 'from-[color:var(--ai-secondary)] to-[color:var(--ai-primary)]'
