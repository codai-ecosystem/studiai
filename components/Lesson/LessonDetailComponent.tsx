...
export default function LessonDetailComponent({
  ...
  if (
    ...
    return (
      <div className="p-8 text-center">Error: Invalid lesson parameters</div>
    );
  }
  ...
  if (!context) {
    throw new Error(
      'LessonDetailComponent must be used within an AppContextProvider'
    );
  }
  ...
  useEffect(() => {
    ...
    console.log(
      'Debug info - courseLessons exists:',
      Boolean(lessons[courseId])
    );
  ...
  useEffect(() => {
    ...
    if (
      ...
      console.log(
        'Debug info - attempting to fetch lessons for course:',
        courseId
      );
        ...
        <Card className="p-6 shadow-lg">
          <div className="text-center py-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              The course you&apos;re looking for doesn&apos;t exist or you may
  ...
  if (Array.isArray(courseLessons)) {
    console.log(
      `Looking for lesson ${lessonId} in array of ${courseLessons.length} lessons`
    );
    lesson = courseLessons.find(l => l.id === lessonId);
    if (!lesson) {
      console.log(
        `Lesson ${lessonId} not found in array. Available lessons:`,
        courseLessons.map(l => ({ id: l.id, name: l.name }))
      );
    }
  } else {
    console.log(
      `Looking for lesson ${lessonId} in object with keys:`,
      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="p-6 shadow-lg">
          <div className="text-center py-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              The lesson you&apos;re looking for doesn&apos;t exist or you may
              not have access to it.
            </p>
              ...
              <div className="mt-6 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg text-left">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  ...
                  <li>
                    ...
                    {debug.courseLessonsExist ? 'Yes' : 'No'}
                  </li>
                  <li>
                    Lessons Available: {debug.lessonsAvailable ? 'Yes' : 'No'}
                  </li>
