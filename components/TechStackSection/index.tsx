        ...
        <ScrollAnimationWrapper>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[color:var(--ai-foreground)]">
              Tehnologii pe care le vei învăța
            </h2>
            <p className="text-[color:var(--ai-muted)] max-w-2xl mx-auto">
              Explorează stack-ul modern de tehnologii web și mobile pe care îl
              acoperim în cursurile noastre. Fiecare tehnologie este predată
              prin proiecte practice.
            </p>
          </div>
