...
export const CoursesFilter: React.FC<CoursesFilterProps> = ({
  ...
  const categories = React.useMemo(() => {
    ...
    const allTags = Object.values(context.courses).flatMap(
      (course: Course) => course.tags || []
    );
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex-1">
          <Input
            ...
            startContent={
              <svg
                className="w-5 h-5 text-[color:var(--ai-muted)]"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
        ...
        {/* Category custom select dropdown */}
        <div className="md:w-60 relative">
          ...
          {isSelectOpen && (
            <>
              ...
              >
                <div
                  className={`px-4 py-2.5 cursor-pointer hover:bg-[color:var(--ai-primary)]/5 ${
