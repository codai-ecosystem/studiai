      ...
      return [
        {
          id: 1,
          content:
            'The AI prediction models taught in this course completely transformed my approach to data analysis. The real-time feedback system makes learning intuitive and effective.',
          author: {
            name: 'Alex Johnson',
        ...
        },
        {
          id: 2,
          content:
            "I've taken many ML courses before, but the neural network visualization tools here made complex concepts crystal clear. The hands-on projects with cutting-edge tech were invaluable.",
          author: {
            name: 'Maria Garcia',
        ...
        },
        {
          id: 3,
          content:
            "This platform's approach to teaching transformer models is revolutionary. I went from basic understanding to implementing advanced NLP systems in just weeks.",
          author: {
            name: 'David Kim',
            role: 'NLP Developer',
          ...
          <div className="max-w-2xl mx-auto">
            <p className="text-lg text-[color:var(--ai-muted)] relative">
              <span className="relative z-10">
                Discover how our AI curriculum is empowering professionals to
                break new ground in machine learning and artificial
                intelligence.
              </span>
