...
const Navbar = forwardRef<HTMLElement, NavbarProps>((props, ref) => {
  ...
  const defaultClassName =
    'bg-[color:var(--ai-background)]/80 backdrop-blur-md';
  return (
    <HeroNavbar
...
>((props, ref) => {
  ...
  // @ts-ignore - HeroUI component expecting slightly different props than React's native types
  return (
    <HeroNavbarContent className={className} justify={justify} {...rest} />
  );
});
...
>((props, ref) => {
  ...
  const defaultClassName =
    'bg-[color:var(--ai-background)]/90 backdrop-blur-md pt-6';

  // @ts-ignore - HeroUI component expecting slightly different props than React's native types
  return (
    <HeroNavbarMenu className={`${defaultClassName} ${className}`} {...rest} />
  );
});
