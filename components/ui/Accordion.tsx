...
export default function Accordion({
  ...
  return (
    <AccordionContext.Provider value={{ openItem, toggleItem }}>
      <div
        className={`divide-y divide-[color:var(--ai-card-border)] ${className}`}
      >
        {children}
      </div>
...
export const AccordionItem = ({
  ...
  return (
    <div
      className={`border border-[color:var(--ai-card-border)]/50 rounded-lg mb-3 overflow-hidden ${className}`}
    >
      <button
        type="button"
