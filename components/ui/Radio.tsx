...
export interface RadioProps
  extends Omit<HeroRadioProps, 'isSelected' | 'onValueChange' | 'value'> {
  /**
...
const Radio = forwardRef<HTMLInputElement, RadioProps>((props, ref) => {
  ...
  const defaultClassNames = {
    ...
    control:
      'opacity-0 group-data-[selected=true]:opacity-100 transition-opacity',
  ...
  return <HeroRadio {...heroProps}>{children}</HeroRadio>;
});
