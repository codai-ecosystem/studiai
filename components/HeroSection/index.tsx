      ...
      <div className="container mx-auto px-4 py-20 md:py-32 flex flex-col items-center justify-center min-h-[80vh] relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-3xl mx-auto">
            Cursuri practice de programare pentru dezvoltatori care vor să își
            accelereze cariera. Învață tehnologii moderne direct de la experți
            în domeniu.
          </p>
            ...
            <Button
              onClick={() => {
                const techStackSection =
                  document.getElementById('tech-stack-section');
