...
export default function HeroSection() {
  ...
  const { openModal, closeModal, user, courses, userPaidProducts, reviews } =
    context;
  ...
  useEffect(() => {
    if (Object.keys(courses).length > 0) {
      ...
      setStats({
        ...
        avgRating:
          reviewCount > 0 ? +(ratingSum / reviewCount).toFixed(1) : 4.8,
  ...
  return (
    <div className="relative w-full bg-gradient-to-br from-[color:var(--ai-primary)]/90 via-[color:var(--ai-secondary)]/80 to-[color:var(--ai-accent)]/70 overflow-hidden">
        ...
        >
          <div>
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Learn in-demand technologies from industry experts. Build
              real-world projects with TypeScript, React, Firebase, Node.js, and
              more.
            </motion.p>
            ...
            <motion.div className="mt-10" variants={itemVariants}>
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm text-[color:var(--ai-foreground-inverse)]/90 font-medium">
                  <span className="text-[color:var(--ai-secondary)] font-semibold">
                    {stats.totalStudents}+
                  </span>{' '}
                  developers already enrolled
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 z-10 rounded-lg bg-white/10 backdrop-blur-md border border-[color:var(--ai-secondary)]/30 shadow-xl p-4 flex items-center gap-3 transform hover:scale-105 transition-transform duration-300">
              ...
              <div>
                <p className="text-sm font-medium text-[color:var(--ai-foreground-inverse)]">
                  {stats.totalCourses} Courses Available
                </p>
                <p className="text-xs text-[color:var(--ai-foreground-inverse)]/80">
            ...
            <div className="absolute -top-6 -right-6 z-10 rounded-lg bg-white/10 backdrop-blur-md border border-[color:var(--ai-secondary)]/30 shadow-xl p-4 transform hover:scale-105 transition-transform duration-300">
              <div className="text-center">
                <p className="text-sm font-medium text-[color:var(--ai-foreground-inverse)]/90">
                  Student Rating
                </p>
                ...
                <p className="mt-1 text-xl font-bold text-[color:var(--ai-foreground-inverse)]">
                  {stats.avgRating}
                  <span className="text-sm text-[color:var(--ai-foreground-inverse)]/70">
                    /5
                  </span>
                </p>
                <p className="text-xs text-[color:var(--ai-foreground-inverse)]/70">
                  from {stats.totalReviews || 42} reviews
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
        <p className="text-[color:var(--ai-foreground-inverse)]/80 text-sm mb-2">
          Scroll to explore
        </p>
        <motion.div
