  ...
  const pathSteps = [
    {
      ...
      description:
        'Master the essential building blocks of modern web development with HTML, CSS, and JavaScript.',
    ...
    },
    {
      ...
      description:
        'Build interactive user interfaces with React, TypeScript, and modern CSS frameworks.',
      color:
        'from-[color:var(--ai-secondary)] to-[color:var(--ai-secondary)]/70',
    },
    {
      number: '03',
      title: 'Backend Integration',
      description:
        'Create robust server-side applications with Node.js and integrate with databases.',
        ...
        <ScrollAnimationWrapper>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[color:var(--ai-muted)] max-w-3xl mx-auto">
              A structured path to take you from basics to professional
              developer
            </p>
          </div>
        </ScrollAnimationWrapper>
              ...
              <div key={step.number} className="relative">
                <ScrollAnimationWrapper delay={index * 0.1}>
                  ...
                  >
                    ...
                    >
                      <h3 className="text-2xl font-bold mb-3 text-[color:var(--ai-foreground)]">
                        {step.title}
                      </h3>
                ...
                <div className="absolute inset-0 opacity-5 pointer-events-none">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'radial-gradient(rgba(var(--ai-primary-rgb), 0.6) 1px, transparent 1px)',
