...
export async function generateMetadata({
  ...
  try {
    ...
    console.log(
      '[generateMetadata] Resolved params - courseId:',
      courseId,
      'lessonId:',
      lessonId
    );
    ...
    return constructMetadata({
      ...
      description:
        lesson.description ||
        `Learn ${lesson.title || lesson.name} in ${course.name}`,
      keywords: [
        course.name,
      ...
      modifiedTime: lesson.lastModified
        ? new Date(lesson.lastModified).toISOString()
        : undefined,
    ...
    return {
      title: 'Course Lesson',
      description:
        'View this lesson content and continue your learning journey.',
    };
  }
}
...
export default async function Page({
  ...
  try {
    ...
    try {
      ...
      const lessonExists = await getLessonById(
        courseIdFallback,
        lessonIdFallback
      );
      ...
      if (!lessonExists) {
        ...
        return (
          <div className="flex flex-col items-center justify-center min-h-screen p-4">
            ...
            <p className="mb-6">
              The lesson you're looking for doesn't exist or you may not have
              access to it.
            </p>
            <a
