...
export default function PrivacyPolicy() {
  return (
    <PolicyPage title="Privacy Policy" lastUpdated="April 4, 2025">
      ...
      <p>
        Welcome to Cursuri (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;).
      ...
      <ul className="list-disc pl-6 mb-4">
        ...
        <li>
          <strong>Marketing cookies:</strong> Allow us to deliver relevant
          advertisements
        </li>
      </ul>
      <p>
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>
          <strong>Business partners:</strong> To offer certain products,
        ...
        <li>
          <strong>Affiliates:</strong> With our parent company, subsidiaries,
          and affiliates
        </li>
        <li>
        ...
        <li>
          ...
          property, or safety of Cursuri, our users, or others
        </li>
        <li>
      ...
      <p>
        ...
        unauthorized access, use, alteration, and disclosure. However, please
      ...
      <p>
        ...
        necessary for the purposes set out in this privacy policy, or as needed
      ...
      <p>
        Depending on your location, you may have rights concerning your personal
        information, such as:
      </p>
      <ul className="list-disc pl-6 mb-4">
      ...
      <p>
        Our platform is not intended for individuals under 16 years of age. We
        do not knowingly collect personal information from children under 16. If
        we learn we have collected personal information from a child under 16,
