  ...
  return (
    <PolicyPage title="Terms and Conditions" lastUpdated="April 4, 2025">
      <Section title="1. Introduction">
        <Paragraph>
          Welcome to Cursuri. These Terms and Conditions govern your use of our
          website, courses, and services. By accessing or using our platform,
          you agree to be bound by these Terms.
        </Paragraph>
        <Paragraph>
          Please read these Terms carefully before using our services. If you do
          not agree with any part of these Terms, you must not use our platform.
        </Paragraph>
      </Section>
      ...
      <Section title="2. Definitions">
        ...
        <List
          items={[
            <>
              <strong>&quot;Platform&quot;</strong> refers to the Cursuri
              website and all its contents, features, and services.
            </>,
            <>
              <strong>
                &quot;User,&quot; &quot;You,&quot; and &quot;Your&quot;
              </strong>{' '}
              refer to the individual or entity accessing or using the Platform.
            </>,
            <>
              <strong>
                &quot;We,&quot; &quot;Us,&quot; and &quot;Our&quot;
            ...
            <>
              <strong>&quot;Content&quot;</strong> refers to course materials,
              videos, text, graphics, images, and other materials available on
              the Platform.
            </>,
            <>
              <strong>&quot;Subscription&quot;</strong> refers to the paid
              access to courses or services offered on the Platform.
            </>,
          ]}
        />
      </Section>
      ...
      <Section title="4. User Conduct">
        <Paragraph>By using our Platform, you agree not to:</Paragraph>
        <List
          items={[
      ...
      <Section title="5. Intellectual Property">
        <Paragraph>
          All content on the Platform, including courses, videos, text,
          graphics, logos, and software, is the property of Cursuri or its
          content providers and is protected by copyright, trademark, and other
          intellectual property laws.
        </Paragraph>
        <Paragraph>
          You are granted a limited, non-exclusive, non-transferable license to
          access and use the content for personal, non-commercial purposes. You
      ...
      <Section title="6. Courses and Subscriptions">
        <Subsection title="Course Access">
          <Paragraph>
            Upon purchasing a course or subscription, you will be granted access
            to the course materials for the specified period. Access may vary
            depending on the type of course or subscription purchased.
          </Paragraph>
        </Subsection>
        ...
        <Subsection title="Payments and Refunds">
          <Paragraph>
            ...
            Prices for courses and subscriptions are subject to change without
            notice. We may offer refunds at our discretion according to our
            refund policy.
          </Paragraph>
        </Subsection>
        ...
        <Subsection title="Course Updates">
          <Paragraph>
            We strive to keep our course content up-to-date. We reserve the
            right to modify, update, or remove course content at any time
            without notice.
          </Paragraph>
        </Subsection>
      </Section>
      ...
      <Section title="7. User-Generated Content">
        <Paragraph>
          Certain parts of our Platform may allow users to post content, such as
          reviews, comments, or forum posts. By posting content, you grant us a
        ...
        <Paragraph>
          ...
          the content you post and that such content does not violate the rights
          of any third party.
        </Paragraph>
      </Section>
      ...
      <Section title="9. Disclaimer of Warranties">
        ...
        <Paragraph>
          ...
          uninterrupted, secure, or that any defects will be corrected.
        </Paragraph>
      </Section>

      <Section title="10. Limitation of Liability">
        <Paragraph>
          In no event shall Cursuri be liable for any indirect, incidental,
      ...
      <Section title="11. Indemnification">
        <Paragraph>
          You agree to indemnify, defend, and hold harmless Cursuri and its
      ...
      <Section title="13. Changes to Terms">
        <Paragraph>
          ...
          Your continued use of the Platform after any such changes constitutes
