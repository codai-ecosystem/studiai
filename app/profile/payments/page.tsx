...
export default function PaymentHistory() {
  ...
  const downloadInvoice = (payment: any) => {
    ...
    alert(
      `Invoice ${payment.invoiceId} for ${payment.courseName} would be downloaded now.`
    );
      ...
      >
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[color:var(--ai-muted)] max-w-2xl">
            View your transaction history and download invoices for all your
            course purchases.
          </p>
        </div>
          ...
          {searchTerm ? (
            <>
              ...
              <p className="text-[color:var(--ai-muted)] mb-6 max-w-md mx-auto">
                We couldn't find any payments that match your search. Try
            ...
            <>
              ...
              <p className="text-[color:var(--ai-muted)] mb-6 max-w-md mx-auto">
                ...
                courses to find the perfect learning opportunity!
              </p>
              <Link href="/courses">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-[color:var(--ai-muted)]">
              ...
              with refunds, please contact our support team at{' '}
              <a
