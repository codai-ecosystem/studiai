  ...
  if (authLoading) {
    return (
      <div className="min-h-screen bg-[color:var(--ai-background)] pt-16 pb-12 flex items-center justify-center">
        <div className="animate-pulse text-[color:var(--ai-primary)] text-lg">
          Loading...
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-[color:var(--ai-background)] pt-12 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div
            className={`${isMainProfilePage ? 'col-span-12' : 'hidden'} md:block lg:col-span-3`}
          >
            <ProfileSidebar />
          </div>
          ...
          <div
            className={`${isMainProfilePage ? 'mt-8 md:mt-0' : ''} lg:col-span-9 col-span-12`}
          >
            <motion.div
