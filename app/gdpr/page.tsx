  ...
  return (
    <PolicyPage title="GDPR Policy" lastUpdated="April 4, 2025">
      <Section title="1. Introduction">
        {' '}
        <Paragraph>
          This GDPR Policy explains how Cursuri (&quot;we,&quot;
          &quot;our,&quot; or &quot;us&quot;) processes personal data in
          accordance with the General Data Protection Regulation (GDPR) and
          outlines your rights as a data subject.
        </Paragraph>
        <Paragraph>
          We are committed to protecting your privacy and handling your data in
          an open and transparent manner. This policy applies where we are
      ...
      <Section title="2. Data Controller">
        <Paragraph>
          Cursuri is the data controller responsible for your personal data. If
          you have any questions about this GDPR Policy or our data practices,
      ...
      <Section title="3. Categories of Personal Data We Process">
        ...
        <List
          items={[
            ...
            <>
              <strong>Financial Data:</strong> Payment information, purchase
              history
            </>,
            <>
              <strong>Technical Data:</strong> IP address, browser type and
              version, time zone setting, device information
            </>,
            <>
              <strong>Profile Data:</strong> Username, password, purchases,
              interests, preferences
            </>,
            <>
              <strong>Usage Data:</strong> Information about how you use our
              platform, courses viewed, completion rates
            </>,
            <>
              <strong>Marketing Data:</strong> Preferences in receiving
              marketing from us
            </>,
          ]}
        />
      ...
      <Section title="4. How We Collect Your Personal Data">
        <Paragraph>We collect personal data through various methods:</Paragraph>
        <List
          items={[
            <>
              <strong>Direct interactions:</strong> When you create an account,
              purchase courses, or contact us
            </>,
            <>
              <strong>Automated technologies:</strong> As you interact with our
              platform, we may automatically collect Technical Data
            </>,
            <>
              <strong>Third parties:</strong> We may receive data from analytics
              providers, payment providers, and social media platforms
            </>,
          ]}
        />
      </Section>
      ...
      <Section title="5. Legal Basis for Processing">
        <Paragraph>
          We will only process your personal data when we have a legal basis to
          do so. The legal bases we rely on include:
        </Paragraph>
        <List
          items={[
            <>
              <strong>Consent:</strong> When you have explicitly agreed to the
            ...
            <>
              <strong>Legal obligation:</strong> When processing is necessary
              for compliance with a legal obligation
            </>,
            <>
              <strong>Legitimate interests:</strong> When processing is
              necessary for our legitimate interests, provided they are not
      ...
      <Section title="7. Data Retention">
        ...
        <Paragraph>
          Different retention periods apply to different types of data. To
          ...
          purposes for which we process it, and whether we can achieve those
      ...
      <Section title="8. Data Sharing">
        ...
        <List
          items={[
            <>
              ...
              services to us, such as payment processing, analytics, marketing
            </>,
            <>
        ...
        <Paragraph>
          ...
          data and to treat it in accordance with the law. We only permit our
          third-party service providers to process your personal data for
      ...
      <Section title="9. International Transfers">
        <Paragraph>
          ...
          Economic Area (EEA). Whenever we transfer your personal data outside
        ...
        <List
          items={[
            ...
            <>
              ...
              can request human intervention for decisions based solely on
      ...
      <Section title="11. Data Security">
        <Paragraph>
          ...
          to protect your personal data against unauthorized access, accidental
          loss, alteration, or disclosure. These measures include encryption,
          access controls, regular security assessments, and staff training.
        </Paragraph>
        <Paragraph>
          We regularly review our security practices to ensure ongoing
      ...
      <Section title="12. Cookies and Similar Technologies">
        <Paragraph>
          ...
          our platform. For detailed information about how we use cookies,
          please see our Cookie Policy available on our platform.
        </Paragraph>
      </Section>
      ...
      <Section title="14. Complaints">
        <Paragraph>
          If you have concerns about our data processing practices, please
          contact us first. You also have the right to lodge a complaint with
          your local data protection authority if you believe we have not
