...
export const siteConfig = {
  name: 'Cursuri',
  description:
    'Advance your career with expert-led online courses in programming, technology, and digital skills.',
 ...
 * @returns Metadata object for Next.js
 */
export function constructLessonMetadata(
  lesson: {
    title: string;
    description?: string;
    isFree?: boolean;
  ...
  const { title: courseTitle, instructorName, id = courseId } = course;
  ...
  const metaDescription =
    description ||
    `${lessonTitle} - Part of the ${courseTitle} course. Learn at your own pace with Cursuri.`;
